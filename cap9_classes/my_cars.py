...
# definidno o odometro inicial de forma direta (atibuição)
...
# definindo a capacidade do tanque de combustivel diretamente (atribuição)
my_car.capacity_combust_tank = 40
...
# definindo e obtendo a capacidade do tanque
my_car.capacity_combust_tank = 70.0
tank_capacity_info = my_car.fill_gas_tank_description()
...
# incrementando o odometro pelo metodo increment_odometer
my_car.increment_odometer(480)
km_acrescentado = my_car.read_odometer()

# definindo e obtendo a capacidade do tanque
my_car.capacity_combust_tank = 48.0
tank_capacity_info = my_car.fill_gas_tank_description()
